      ...
      >
        ...
        <div class="flex items-center justify-between h-16 px-6 border-b border-gray-200">
          <router-link to="#" class="flex items-center space-x-2">
            ...
            <span v-if="!isCollapsed" class="text-xl font-bold text-gray-900">Adera Events</span>
          </router-link>
    ...
    <span v-if="!isCollapsed">{{ item.name }}</span>
        ...
        >
          ...
          <div v-if="!isCollapsed" class="ml-3">
            <p class="text-sm font-medium text-gray-900">Tseganesh</p>
            <p class="text-xs text-gray-500">Event Coordinator</p>
          </div>
        </div>
      </aside>
    </div>
